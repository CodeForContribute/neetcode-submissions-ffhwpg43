class Solution {
    ...
    public List<List<Integer>> pacificAtlantic(int[][] heights) {
        ...
        // add all the top row and left col to pacQ
        // add all the right col and last row to atlQ.
        // keep a boolean arr for all the cells which can be reached to pac.
        // keep a boolean arr for all the cells which can be reached to atl.
        // take an intersections of these 2 boolean arr - to get the answer.
